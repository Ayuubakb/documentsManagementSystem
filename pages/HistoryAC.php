...
<head>
    ...
    <script src="../js/AC_PDF.js"></script>
...
<nav>
    ...
    <section>
        <div class="triContainer">
            ...
            <p id='tableType'>Acandemic Transcripts History</p>
            <select id="selectBar">
        ...
        <div class="demandContainer" id="demandContainer">
            <?php
                while($resultReq=mysqli_fetch_row($req5_2)){
                    $msg=$resultReq[7]==1?"<h2 style='color:green'>Sended</h2>":"<h2 style='color:red'>Refused</h2>";
                    echo"
                    <div id='".$resultReq[6]."'>
                        <div>
                        ...
                        <div>
                            ".$msg."
                            <button onclick=\"generatePdf2('".$resultReq[1]."','".$resultReq[2]."','".$resultReq[0]."','".$resultReq[8]."')\" style='width:50%;margin-left:0;margin-top: 8px;background-color:black'><i class='fa-solid fa-download fa-xl' style='color: #ffffff;'></i></button>
                        </div>
                    </div>
                    ";
                }
